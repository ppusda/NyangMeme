export const memes = [
    ...
    },
    {
        ...
        origin: [
            ...
            { type: 'paragraph', content: `어느 날 주인의 남편이 페이스북에 올린 에델의 사진이 'Ai Dise Gratis'라는 밈으로 사용된 것을 시작으로, 'I wake up...', 그리고 마침내 'OIIA' 회전하는 고양이 밈으로 퍼져나가며 세계적인 명성을 얻게 되었습니다. 주인은 최근까지도 에델의 인기를 실감하지 못했다고 하며, 자신은 밈 제작자가 아닌 그저 '사랑스러운 고양이의 자랑스러운 주인'일 뿐이라고 말합니다. 고양이의 최신 근황과 이야기는 아래 인스타그램에서 확인해볼 수 있습니다.` },
